...
namespace geometry{
    ...
    public:
        ...
        void rotate(Point center, double angle)override{
            for (auto&w:vertices){
                w=geometry::rotate(w,center,angle);
            }
        }
        void reflect(Point center)override{
            for (auto&w:vertices){
                w=geometry::reflect(w,center);			
            }
        }
        void reflect(Line axis)override{
            for (auto&w:vertices){
                w=geometry::reflect(w,axis);
            }
        }
        void scale(Point center, double coefficient)override{
            for (auto&w:vertices){
                w=geometry::scale(w,center,coefficient);
            }
        }
    };
    ...
    public:
        ...
        void rotate(Point center, double angle){
            f1=geometry::rotate(f1,center,angle);
            f2=geometry::rotate(f2,center,angle);
        }
        void reflect(Point center){
            f1=geometry::reflect(f1,center);
            f2=geometry::reflect(f2,center);
        }
        void reflect(Line axis){
            f1=geometry::reflect(f1,axis);
            f2=geometry::reflect(f2,axis);
        }
        void scale(Point center, double coefficient){
            f1=geometry::scale(f1,center,coefficient);
            f2=geometry::scale(f2,center,coefficient);
            a*=abs(coefficient);
            b*=abs(coefficient);
            c*=abs(coefficient);
        }
...
{
    geometry::Triangle _a({
        {double(a.p1.x),double(a.p1.y)},
        {double(a.p2.x),double(a.p2.y)},
        {double(a.p3.x),double(a.p3.y)},
    });
    geometry::Triangle _b({
        {double(b.p1.x),double(b.p1.y)},
        {double(b.p2.x),double(b.p2.y)},
        {double(b.p3.x),double(b.p3.y)},
    });
    return _a.isCongruentTo(_b);
}
