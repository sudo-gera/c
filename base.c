...
int bn_init_string_radix(bn*q , const char*e , int t) {
	...
	if (t < 37) {
		assert(t > 1);
		assert(t < 37);
		qs = (uint32_t)(l/(unsigned)("\x00\x00\x20\x14\x10\x0d\x0c\x0b\x0a\x0a\x09\x09\x08\x08\x08\x08\x08\x07\x07\x07\x07\x07\x07\x07\x06\x06\x06\x06\x06\x06\x06\x06\x06\x06\x06\x06\x06"
				[t])+1) ;
	}
	if (q -> size and q -> vect) {
		free(q -> vect) ;
...
typedef int (*type_f)(bn*, const bn*);
...
int main()
{
	...
	// 		}
	// 		else {
	// 			size_t nw = ""
	// 			[(int)(a[t][w])];
	// 			for (size_t ww = 2; ww < nw + 1; ++ww) {
	// 				s[ww] = 0;
	// 			}
	// 		}
	// 	}
	...
	// 	if (s[w]) {
	// 		for (size_t t = 0; t < tt; ++t) {
	// 			bn_init_string_radix(v, z[t], w);
	// 			bn_init_string_radix(b, x[t], w);
	// 			bn_init_string_radix(n, c[t], w);
	// 			(*(f[t]))(v, b);
	// 			if (bn_cmp(v, n)) {
	// 				s[w] = 0;
	// 			}
